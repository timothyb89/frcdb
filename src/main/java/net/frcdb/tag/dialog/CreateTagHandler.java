 ...
 * @author tim
 */
public class CreateTagHandler extends BodyTagSupport {
	...
	private void writeTagBodyContent(JspWriter out, BodyContent bodyContent) throws IOException {
		out.println("<div class=\"dialog\" style=\"z-index: 2\">");
		out.println("<div class=\"content\" style=\"padding: 15px;\">");
		out.println("<div class=\"wrapper\">");
		out.println("<div class=\"t\"></div>");
		out.println("<div class=\"dialogContent\">");
		bodyContent.writeOut(out);
		out.println("</div>");
		out.println("</div>");
		out.println("</div>");
		out.println("<div class=\"b\"><div></div></div>");
		out.println("</div>");
	...
	private void handleBodyContentException(Exception ex) throws JspException {
		...
		throw new JspException("Error in CreateTagHandler tag", ex);
	}
